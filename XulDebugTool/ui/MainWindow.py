...
class MainWindow(BaseWindow):
    ...
    def initSearchView(self):
        ...
        self.previousBtn.setFixedSize(20, 25)
        ...
        self.nextBtn.setFixedSize(20, 25)
        ...
        self.matchTips.setFixedSize(100, 25)
        ...
        rightLayout.addWidget(self.matchTips)
        rightLayout.addWidget(self.searchClose)
        rightWidget.setLayout(rightLayout)
        searchPageLayout.addWidget(rightWidget)
